...
# Create bar plot
vent_sac_bar <- ggplot(level_filtered, aes(x = year, y = mean_level, fill = county)) +
  geom_col() +
  facet_wrap(~county) +
  labs(x = "Year",
       y = "Mean Shortage Level") +
  scale_fill_manual(values = c("Ventura" = "#DABB8E", "Sacramento" = "#B98B6D"),
                    name = "County") +
  theme_minimal()
...
ggsave("cali_map.png", plot = cali_map, width = 10, height = 10, dpi = 300)
```
